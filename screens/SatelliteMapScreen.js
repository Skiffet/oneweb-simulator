...
export default function SatelliteMapScreen({ onLogout }) {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <Modal
        visible={isPredictionModalOpen}
        animationType="fade"
        transparent={true}
        onRequestClose={() => setIsPredictionModalOpen(false)}
      >
        <View style={styles.modalOverlay}>
                ...
                <FlatList
                  ...
                  renderItem={({ item }) => (
                    <View style={styles.predictionRow}>
                      ...
                      <View style={styles.predInBadge}>
                        <Text style={styles.predInText}>{item.entry_in} MINS</Text>
                      </View>
